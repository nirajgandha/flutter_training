...
import 'package:personal_expenses/widgets/expense_chart_bar_element.dart';

class ExpenseChart extends StatelessWidget {
  final List<Expense> recentExpenses;

  ExpenseChart(this.recentExpenses);
    ...
    return List.generate(7, (index) {
      ...
      for (var i = 0; i < recentExpenses.length; i++) {
        if (recentExpenses[i].date.day == weekDay.day &&
          ...
          totalSum += recentExpenses[i].amount.toDouble();
        }
      }
